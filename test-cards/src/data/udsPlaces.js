...
export const cards = [
   
  {
   id: 1, 
    ...
    rating: 4.56,
    link: "https://um.mos.ru/houses/dokhodnyy-dom-a-a-panteleeva/",
    favorite: false,
    showButton: false, 
    buttonText: "ПЕРЕЙТИ", 
    icons: {
  ...
  },
  {
    ...
    metro: "Арбатская, 3 мин",
    rating: 5,
    link: "https://um.mos.ru/quests/moskva-v-kino/",
    favorite: false,
    showButton: true, 
    buttonText: "ПЕРЕЙТИ", 
    icons: {
  ...
  },
  {
    ...
    metro: "Арбатская, 3 мин",
    rating: 3.56,
    link: "https://um.mos.ru/houses/gorodskaya-usadba-s-b-kurakina-glavnyy-dom/",
    favorite: false,
    showButton: false, 
    buttonText: "ПЕРЕЙТИ", 
    icons: {
  ...
  },
  {
    ...
    metro: "Арбатская, 3 мин",
    rating: 4.56,
    link: "https://um.mos.ru/quests/usadby-v-sovremennoy-moskve/",
    favorite: false,
    showButton: false, 
    buttonText: "ПЕРЕЙТИ", 
    icons: {
  ...
  },
  {
    ...
    metro: "Арбатская, 3 мин",
    rating: 1.50,
    link: "https://um.mos.ru/houses/gorodskaya-usadba-i-t-rahmanova-s-1870-h-gg-sofiyskiy-mehanicheskiy-zavod-akcionernogo-obschestva-g-lista/",
    favorite: false,
    showButton: false, 
    buttonText: "ПЕРЕЙТИ", 
    icons: {
